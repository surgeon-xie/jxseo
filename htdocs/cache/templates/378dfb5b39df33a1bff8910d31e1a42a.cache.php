...
<div class="subnav">
	...
	<div class="table-list">
		...
		<tr>
			...
			<th class="<?php echo ns_sorting('catid'); ?>" name="catid" width="100" align="center"><?php echo lang('cat-00'); ?></th>
		...
		<tr id="dr_row_<?php echo $t['id']; ?>">
			...
			<td align="left"><a title="<?php echo $t['title']; ?>" class="onloading" href="<?php echo dr_url(APP_DIR.'/home/edit',array('id'=>$t['id'])); ?>"><?php if ($t['thumb']) { ?><font color="#FF0000"><?php echo lang('html-387'); ?></font><?php }  echo dr_keyword_highlight(dr_strcut($t['title'], 40), $param['keyword']); ?></a></td>
			<td align="center"><a href="<?php if ($flag) {  echo dr_url(APP_DIR.'/home/index', array('flag'=>$flag,'catid'=>$t['catid']));  } else {  echo dr_url(APP_DIR.'/home/index', array('catid'=>$t['catid']));  } ?>"><?php $cache = $this->_cache_var('CATEGORY'); eval('echo $cache'.$this->_get_var('$t[catid].name').';');unset($cache); ?></a></td>

...
<link rel="stylesheet" href="<?php echo SITE_PATH; ?>dayrui/statics/css/bootstrap-responsive.css" />
<link rel="stylesheet" href="<?php echo SITE_PATH; ?>dayrui/statics/css/style.css" />
<link rel="stylesheet" href="<?php echo SITE_PATH; ?>dayrui/statics/css/font-awesome/css/font-awesome.css" />
<link rel="stylesheet" href="<?php echo SITE_URL; ?>dayrui/statics/css/table_form.css" />
...
$(function(){
	...
	*/
	...
	$.getScript("http://www.dayrui.com/index.php?c=sys&m=version&id=<?php echo DR_VERSION_ID; ?>&admin=<?php echo SELF; ?>");
	<?php } ?>
...
function dr_loading() {
	$('.page-loading').remove();
	$('body').append('<div class="page-loading"><img src="<?php echo SITE_PATH; ?>dayrui/statics/images/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span><?php echo lang('html-699'); ?></span></div>');
}
</script>
</head>
...
<div id="navigation">
    <div class="container-fluid">
        <a href="<?php echo SITE_URL; ?>" id="brand" target="_blank">FineCMS</a>
        ...
        <div class="user">
            ...
            <div class="dropdown" id="dr_member">
                <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:;"><?php echo $admin['username']; ?>&nbsp;<img style="width:27px;height:27px;" src="<?php echo dr_avatar($admin['uid']); ?>" /></a>
                <ul class="dropdown-menu pull-right">
					...
					<li><div class="dr_hr"></div></li>
                    <li><a href="http://www.dayrui.com/" target="_blank"><i class="icon-cloud"></i> <?php echo lang('html-003'); ?></a></li>
                    <li><a href="http://www.finecms.net/" target="_blank"><i class="icon-comment"></i> <?php echo lang('html-004'); ?></a></li>
                    <li><a href="http://help.dayrui.com/" target="_blank"><i class="icon-book"></i> <?php echo lang('html-002'); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="container-fluid" id="content">
    <div id="left">
        <form action="http://help.dayrui.com/index.php" method="get" target="_blank" class="search-form" style="margin:9px 0 0;">
    ...
    <div id="main">
        ...
        &copy; 2011-<?php echo date('Y'); ?>&nbsp;&nbsp;<strong><a class="fine-cms" href="http://www.dayrui.com/cms/" target="_blank"><?php echo DR_NAME; ?></a></strong>&nbsp;v<?php echo DR_VERSION; ?> (<?php echo DR_UPDATE; ?>)&nbsp;&nbsp;<span id="finecms_version"></span> &nbsp;&nbsp;&nbsp;&nbsp;
        </div>
    </div>
</div>

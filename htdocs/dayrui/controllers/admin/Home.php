...
class Home extends M_Controller {
    ...
    public function main() {
        ...
        if ($module) {
            ...
            $total['member'] = array(
                'name' => lang('364'),
                'today' => $this->_set_k_url(3, dr_url('member/home/index')),
                'content' => $this->_set_k_url(3, dr_url('member/home/index')),
                'content_verify' => $this->_set_k_url(3, dr_url('member/home/index')),
                'extend_verify' => 'javascript:;',
                'add' => $this->_set_k_url(3, dr_url('member/home/index')),
                'url' => $this->_set_k_url(3, dr_url('member/home/index')),
            );
        }

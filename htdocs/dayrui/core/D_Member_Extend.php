...
class D_Member_Extend extends M_Controller {
    ...
    public function add() {
        ...
        $this->template->assign(array(
            ...
            'draft_url' => MEMBER_URL.dr_url(APP_DIR.'/extend/add', array('cid' => $this->content['id'], 'catid' => $this->catid)),
    ...
    public function edit() {
        ...
        $this->template->assign(array(
            ...
            'result' => $result,
            'myfield' => $this->field_input($this->field, $data, TRUE),
            'draft_url' => MEMBER_URL.dr_url(APP_DIR.'/extend/edit', array('cid' => $this->content['id'], 'catid' => $this->catid, 'id' => $id)),

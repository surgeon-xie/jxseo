...
class D_Member_Form extends M_Controller {
    ...
    public function index() {
		...
		$tpl = is_file(APPPATH.'templates/member/'.MEMBER_TEMPLATE.'/mform_data_'.$this->form['table'].'.html') ? 'mform_data_'.$this->form['table'].'.html' : 'mform_data.html';
		...
		if ($this->input->get('action') == 'search') {
			...
			$this->template->display(is_file(APPPATH.'templates/member/'.MEMBER_TEMPLATE.'/mform_index_'.$this->form['table'].'.html') ? 'mform_index_'.$this->form['table'].'.html' : 'mform_index.html');
		}
    }
    ...
    public function listc() {
		...
		if ($this->input->get('action') == 'search') {
			...
			$this->template->assign(array(
				'list' => $this->link->limit($this->pagesize)->get($this->table)->result_array(),
				'datatpl' => is_file(APPPATH.'templates/member/'.MEMBER_TEMPLATE.'/mform_cdata_'.$this->form['table'].'.html') ? 'mform_cdata_'.$this->form['table'].'.html' : 'mform_cdata.html',

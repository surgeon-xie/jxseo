...
function dr_avatar($uid, $size = '45') {
    ...
    if (!$uid) {
        return $size == 45 ? SITE_URL.'dayrui/statics/images/avatar_45.png' : SITE_URL.'dayrui/statics/images/avatar_90.png';
    }
    ...
    return isset($data['avatar']) && $data['avatar'] ? dr_get_file($data['avatar']) : ($size == 45 ? SITE_URL.'dayrui/statics/images/avatar_45.png' : SITE_URL.'dayrui/statics/images/avatar_90.png');
}
...
function dr_thumb2($img, $width = 100, $height = 100, $autocut = 1) {
    ...
    if (!$img) {
        return SITE_URL.'dayrui/statics/images/nopic.gif';
    }
